...
crazyflie_param = Dict(
    "gravity" => 9.81,
    # Motor Parameters
    "rotation_damping" => [ 1.0*10e-8; 1.0*10e-8; 1.0*10e-8],
    "translation_damping" => [ 9.0*10e-7; 9.0*10e-7; 9.0*10e-7],
    # Rigid Body
    "mass" => 0.028,
    "inertia" => ([16.571710 0.830806 0.718277; 0.830806 16.655602 1.800197; 0.718277 1.800197 29.261652] .* (10e-6)),
    "inertia_inv" => inv([16.571710 0.830806 0.718277; 0.830806 16.655602 1.800197; 0.718277 1.800197 29.261652] .* (10e-6)),
    "CoM" => [ 0.0; 0.0; 0.0],
)
